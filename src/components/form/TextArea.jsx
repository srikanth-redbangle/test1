...
export const TextArea = ({
  ...
  return (
    <label htmlFor={name} className={`block w-full ${labelClassName}`}>
      ...
      <textarea
        className={`w-full font-semibold bg-transparent text-input md:text-input-large placeholder:text-rb-black/40 text-rb-black placeholder:font-medium placeholder:text-base ${
